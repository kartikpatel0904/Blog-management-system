...
user_route.get('/forget-password',adminLoginAuth.isLogin,userController.forgetLoad);
user_route.post('/forget-password'.userController.forgetPasswordVerify);

user_route.get('forget-password',adminLoginAuth.isLogout,userController.resetPasswordLoad);
